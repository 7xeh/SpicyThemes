...
Needs Spotify Desktop, Spicetify `>= 2.0.0`, and the [Spicy Lyrics](https://github.com/Spikerko/spicy-lyrics) extension.

1. Open Spotify and go to **Marketplace → Extensions**.
2. Search for **Spicy Themes** and install it.
3. Restart Spotify, play a track, and open the lyrics view.

Prefer to install by hand, or want the full requirements list? See **[Installation](docs/installation.md)**.

Then click the **palette icon** in the lyrics controls to toggle theming, and **right-click it** to open the settings modal.
...
| Guide | Covers |
|---|---|
| [Installation](docs/installation.md) | Requirements, Spicetify Marketplace install, manual install. |
| [Getting started](docs/getting-started.md) | Your first run, the palette button, and a tour of the settings modal. |
| [Settings reference](docs/settings.md) | Every setting, grouped exactly as it appears in the Customize tab. |
| [Presets](docs/presets.md) | The 8 built-in presets and how to save your own. |
| [Creating and sharing themes](docs/themes.md) | Marketplace, Theme Creator, and export / import. |
| [Translator support](docs/translator.md) | Styling Spicy Lyric Translator lines. |
